          ...
          <tbody>
            <tr>
              <td width="567" height="60">
                <table width="570" height="60" border="0" align="center">
                <tr>
                  <td width="170" height="25"><strong><font face="verdana">Fecha</font></strong></td>
                  <td width="170" height="25"><strong><font face="verdana">Latitud</font></strong></td>
                  <td width="170" height="25"><strong><font face="verdana">Longitud</font></strong></td>
                </tr>
                <tr>
                  <td align="center"><script>document.write(fecha,"</br>");</script></td>
                  <td align="center"><script>document.write(lat,"</br>");</script></td>
                  <td align="center"><script>document.write(longi,"</br>");</script></td>
                </tr>
              </table>
            </td>
          </tr>
